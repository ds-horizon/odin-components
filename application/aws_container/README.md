...
| `tags`         | [object](#tags)          | **Yes**  | Custom labels to add to created resources          |
...
| Property     | Type    | Required | Description                                                  |
|--------------|---------|----------|--------------------------------------------------------------|
| `name`       | string  | **Yes**  | The name of the port                                         |
| `path`       | string  | **Yes**  | The path of for which requests should be routed to this port |
| `port`       | integer | **Yes**  | The port number to expose                                    |
| `protocol`   | string  | **Yes**  | The protocol of the port, e.g. TCP                           |
